...
COPY pipeline/client/blocksci_s3_template.sh pipeline/client/blocksci_parse_s3_template.sh pipeline/client/blocksci_update_s3_template.sh pipeline/client/blocksci_analyze_s3_template.sh pipeline/client/coinjoin_analysis_s3_template.sh pipeline/client/mappings_s3_template.sh pipeline/client/unified_report_s3_template.sh /app/client/
