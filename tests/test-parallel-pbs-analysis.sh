...
DIPLOMKA_ROOT="${DIPLOMKA_ROOT:-$(cd "${PROJECT_DIR}/.." && pwd)}"
...
CLUSTER_NAME="${CLUSTER_NAME:-cj-${ENGINE}-pbs-parallel-$$}"
NAMESPACE="${NAMESPACE:-cj-${ENGINE}-pbs-parallel-$$}"
PBS_CONTAINER_NAME="${PBS_CONTAINER_NAME:-pbs-${ENGINE}-parallel-itest-$$}"
